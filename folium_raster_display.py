def folium_raster_display(
    file_path, file_name, tile_name="OpenstreetMap", control_scale=False, zoom_start=10, m=True
):
    """
    ...
    Args:
        ...
        m(bool): Defualt is True. Whether to Generate a base map.
    Returns:
